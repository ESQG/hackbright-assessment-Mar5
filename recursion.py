...
def print_all_tree_data(tree):
    ...
    """
    # I would write "if tree" here if leaves were grounded to None instead of having [] as children.
    print tree.data
...
def num_nodes(tree):
    ...
    # if not tree:        # don't really need this, but would if children were set to None
    #     return 0
    total = 1
    for child in tree.children:
